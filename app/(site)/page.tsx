  ...
  return (
    <div className="max-w-5xl mx-auto py-20 px-10">
      ...
      <div className="flex gap-2 items-end gap-2">
        ...
        <button className="font-semibold text-pink-600 items-center rounded h-9">
          <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" className="w-5" viewBox="0 0 24 24">
